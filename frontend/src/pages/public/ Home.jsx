...
const features = [
{
title: 'Solicitação eletrónica',
text: 'Peça documentos académicos sem deslocações.',
},
{
title: 'Pagamentos Multicaixa',
text: 'Referências geradas automaticamente pelo sistema.',
},
{
title: 'Acompanhamento em tempo real',
text: 'Consulte o estado das suas solicitações.',
},
{
title: 'Notificações automáticas',
text: 'Receba actualizações sobre pedidos e pagamentos.',
},
{
title: 'Validação por QR Code',
text: 'Confirme a autenticidade dos documentos emitidos.',
},
{
title: 'Documentos digitais',
text: 'Visualize e faça download dos documentos emitidos.',
},
];
...
return ( <div className="home"> <header className="home-header"> <div className="container header-content"> <div className="logo"> <img src="/images/logo.png" alt="SIGAR" /> <div> <h3>SIGAR</h3> <span>Sistema Integrado de Gestão Académica e Registos</span> </div> </div>
    ...
    <div className="container hero-grid">
      <div className="hero-text">
        <div className="hero-badge">
          Transformação digital académica
        </div>
